...
module.exports = async function handler(req, res) {
  ...
  // VK can send the initial confirmation request before the secret check is useful.
  // For confirmation, return the exact confirmation string first; validate the secret for all other events.
